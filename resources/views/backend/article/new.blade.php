                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="theme">
                                            @foreach($themes as $theme)
                                                <option name="theme" value="{{ $theme->id }}">{{ $theme->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="active" id="active1" value="option1" checked>
                                                Oui
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="active" id="active2" value="option2">
                                                Non
                                            </label>
                                        </div>
                                    </div>
